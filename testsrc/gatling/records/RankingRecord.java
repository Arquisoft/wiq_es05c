...
public class RankingRecord extends Simulation {
  ...
  private ScenarioBuilder scn = scenario("RankingRecord")
    .exec(
      http("request_0")
        .post("http://" + uri1 + ":8005/socket.io/?EIO=4&transport=polling&t=OyMfx5N&sid=o67mn_LmUVu75EzWAAAe")
        .headers(headers_0)
        .body(RawFileBody("rankingrecord/0000_request.json"))
        .check(status().is(400)),
      pause(1),
      http("request_1")
        ...
        .resources(
          http("request_2")
            .get("http://" + uri1 + ":8005/socket.io/?EIO=4&transport=polling&t=OyMf_OG")
            .headers(headers_2),
          http("request_3")
          ...
          http("request_4")
            ...
            .headers(headers_4),
          http("request_5")
            .post("http://" + uri1 + ":8005/socket.io/?EIO=4&transport=polling&t=OyMf_P7&sid=9Y4MTrOWhztmUmbvAAAg")
            .headers(headers_0)
            .body(RawFileBody("rankingrecord/0005_request.html")),
          http("request_6")
            .get("http://" + uri1 + ":8005/socket.io/?EIO=4&transport=polling&t=OyMf_P7.0&sid=9Y4MTrOWhztmUmbvAAAg")
            .headers(headers_2)
        ),
      pause(11),
      http("request_7")
        ...
        .resources(
          http("request_8")
            .post("/login")
            .headers(headers_8)
            .body(RawFileBody("rankingrecord/0008_request.json")),
          http("request_9")
